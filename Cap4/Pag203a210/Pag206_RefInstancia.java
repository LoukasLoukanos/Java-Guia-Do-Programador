...
public class Pag206_RefInstancia {
	public static void main(String[] args) throws Exception {
		// Instanciação de circunferência
		P0408Circunferencia circ = new P0408Circunferencia(2.0);

		// Método de isntância de objeto específico com assinatura double (void)
		IntToDoubleFunction funMedida = circ::getMedida;

		// Método de isntância de objeto específico com assinatura double (void)
		DoubleSupplier supArea = circ::area;

		// Método de isntância de objeto específico com assinatura void(double, double)
