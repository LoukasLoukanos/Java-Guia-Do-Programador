...
public class Pag205_RefEstataticos {
	public static void main(String[] args) {
		// Métodos estáticos com assinatura double (double)
		...
		// Métodos estático com assinatura double (double, double)
		...
		// Expressões lambda equivalentes aos métodos estático acima ↑
